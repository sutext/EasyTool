...
#import "ETEncryptor.h"
@interface ETEncryptor()
@property(nonatomic)SecKeyRef publicKey;
@end
@implementation ETEncryptor
+(instancetype)encryptorWithPath:(NSString *)pubkeyPath
{
...
+(SecKeyRef)getPublickKey:(NSString *)certPath {
    SecTrustRef trust;
